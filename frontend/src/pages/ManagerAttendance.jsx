    ...
    <div className="container mx-auto px-4 py-6 bg-gradient-to-br from-slate-50 to-[#700606]/5">
      ...
      <div className="bg-gradient-to-r from-[#700606] to-[#a04040] rounded-xl p-6 mb-6 text-white">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold mb-2">Team Attendance Monitoring</h1>
            <p className="text-white/80 text-sm">Monitor and analyze your team's attendance data</p>
            <p className="text-white/60 text-xs mt-1">System-generated records from staff check-in/out</p>
          </div>
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        {loading || dateChanging ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">No team attendance recorded for this date.</p>
          </div>
        ) : (
