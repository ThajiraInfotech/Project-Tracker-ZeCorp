                            ...
                            {staffFilteredHistory.map((record) => (
                              <div key={record._id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                                ...
                                <div className="bg-gray-50 rounded-lg p-3 flex flex-col gap-2">
                                  ...
                                  {(record.totalHours > 0 || record.overtimeHours > 0) && (
                                    <div className="pt-2 border-t border-gray-100 flex items-center justify-between text-xs sm:text-sm">
                                      <span className="text-gray-500">Regular: {record.regularHours || 0}h</span>
                                      <span className="text-purple-600 font-medium">Overtime: {record.overtimeHours || 0}h</span>
                                    </div>
                                  )}
                                </div>
                              </div>
