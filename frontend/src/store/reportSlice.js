...
export const getAdminDashboardData = createAsyncThunk(
  ...
  async (timeContext = 'today', { rejectWithValue }) => {
    try {
      const response = await api.get('/reports/dashboard/admin', { params: { timeContext } });
      return response.data;
    } catch (error) {
...
export const getManagerPerformanceReport = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await api.get('/reports/admin/manager-performance');
      return response.data;
    } catch (error) {
...
export const getStaffProductivityReport = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await api.get('/reports/admin/staff-productivity');
      return response.data;
    } catch (error) {
...
export const getAttendanceReport = createAsyncThunk(
  ...
  async (params, { rejectWithValue }) => {
    try {
      const response = await api.get('/reports/admin/attendance', { params });
      return response.data;
    } catch (error) {
...
export const getDelayRiskAnalysisReport = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await api.get('/reports/admin/delay-risk');
      return response.data;
    } catch (error) {
