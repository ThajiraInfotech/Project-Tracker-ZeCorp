    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex space-x-2">
            <button
              className={`px-3 py-1 text-sm rounded-full ${activeTab === 'overview' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'}`}
              onClick={() => setActiveTab('overview')}
            >
              Overview
            </button>
            <button
              className={`px-3 py-1 text-sm rounded-full ${activeTab === 'analytics' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'}`}
              onClick={() => setActiveTab('analytics')}
            >
              Analytics
            </button>
            <button
              className={`px-3 py-1 text-sm rounded-full ${activeTab === 'reports' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'}`}
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-orange-200 bg-orange-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Delayed Projects */}
          <Link to="/projects" className="bg-red-50 p-4 rounded-lg border border-red-200 hover:bg-red-100 transition-colors cursor-pointer">
          ...
          {/* At-Risk Projects */}
          <Link to="/projects" className="bg-yellow-50 p-4 rounded-lg border border-yellow-200 hover:bg-yellow-100 transition-colors cursor-pointer">
            <div className="flex items-center justify-between">
              <div>
          ...
          {/* Overdue Tasks */}
          <Link to="/tasks" className="bg-orange-50 p-4 rounded-lg border border-orange-200 hover:bg-orange-100 transition-colors cursor-pointer">
            <div className="flex items-center justify-between">
              <div>
