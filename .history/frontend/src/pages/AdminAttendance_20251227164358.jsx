      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl p-6 mb-6 text-white">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
          <div>
            ...
            <p className="text-indigo-100 text-sm">Monitor and analyze attendance data across the organization</p>
            <p className="text-indigo-200 text-xs mt-1">System-generated records from staff check-in/out</p>
          </div>
