    ...
    <div className="space-y-6 bg-gradient-to-br from-slate-50 to-[#700606]/5 min-h-screen p-6">
      ...
      <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-white/20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <Link to="/tasks" className="bg-gradient-to-br from-[#700606]/20 to-[#700606]/30 p-6 rounded-xl border border-[#700606]/30 hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer text-center group">
            ...
            <div className="text-sm text-[#700606] font-semibold">View My Tasks</div>
          ...
          <Link to="/projects" className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-xl border border-green-200/50 hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer text-center group">
            ...
            <div className="text-sm text-green-700 font-semibold">My Projects</div>
          ...
          <Link to="/attendance" className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-6 rounded-xl border border-yellow-200/50 hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer text-center group">
            ...
            <div className="text-sm text-yellow-700 font-semibold">Attendance</div>
          ...
          <Link to="/reports" className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-xl border border-purple-200/50 hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer text-center group">
            ...
            <div className="text-sm text-purple-700 font-semibold">Reports</div>
