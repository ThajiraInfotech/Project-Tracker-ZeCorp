...
const Performance = () => {
  ...
  // Assuming we have tasks and attendance data, but for now using dummy data
  const completedTasks = 5; // dummy
  const presentDays = 20; // dummy
  const totalCheckIns = 22; // dummy
