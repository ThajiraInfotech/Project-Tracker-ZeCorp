    ...
    >
      ...
      <div className="mb-4">
        <div className="flex justify-between items-center mb-2">
          ...
          <p className="text-sm font-semibold text-blue-600">{project.progress || 0}%</p>
        </div>
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 text-sm mb-4">
        <div className="bg-blue-50 rounded-lg p-3">
          ...
          <p className="font-semibold text-blue-600">{record.daysPresent}</p>
        </div>
        <div className="bg-green-50 rounded-lg p-3">
          <p className="text-gray-500 text-xs uppercase tracking-wide">Total Hours</p>
          <p className="font-semibold text-green-600">{record.totalHours?.toFixed(1) || 0}h</p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {[
                ...
                <motion.div
                  ...
                  whileHover={{ scale: 1.02 }}
                  className={`bg-white rounded-xl p-6 shadow-lg border-l-4 border-${kpi.color}-500`}
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">{kpi.title}</p>
                      <p className="text-2xl font-bold text-gray-900 mt-1">{kpi.value}</p>
                      <p className={`text-sm mt-1 text-${kpi.color}-600`}>{kpi.change} from last month</p>
                    </div>
                    <div className={`p-3 rounded-full bg-${kpi.color}-100`}>
                      <kpi.icon className={`text-xl text-${kpi.color}-600`} />
                    </div>
                  </div>
                </motion.div>
              ))}
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-blue-600">{staff.totalHours}h</p>
                      </div>
                    </div>
                  </motion.div>
                ))}
