...
const ProjectControl = () => {
  ...
  useEffect(() => {
    // For now, skip fetching managers to avoid API issues
    // TODO: Re-enable when backend is fully set up
    setManagers([]);
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="bg-blue-50 rounded-lg p-4">
              <h3 className="text-lg font-medium text-gray-900 mb-2">Project Manager Assignment</h3>
              <p className="text-sm text-gray-600 mb-4">Select a manager who will oversee this project</p>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Project Manager *
                </label>
                ...
                >
                  <option value="">
                    {managers.length === 0 ? 'No managers available - please create managers first' : 'Select a project manager'}
                  </option>
