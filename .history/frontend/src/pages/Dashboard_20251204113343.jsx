        ...
        <div className="bg-white p-4 rounded-lg shadow-sm border">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{dashboardData?.dashboard?.projects?.totalProjects || 0}</p>
            </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm border">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{dashboardData?.dashboard?.projects?.totalProjectsInProgress || 0}</p>
            </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm border">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{dashboardData?.dashboard?.tasks?.totalTasksCompleted || 0}</p>
            </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm border">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{dashboardData?.dashboard?.tasks?.totalTasksOverdue || 0}</p>
            </div>
