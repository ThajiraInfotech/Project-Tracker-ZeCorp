...
exports.checkIn = async (req, res) => {
  try {
    const { location, deviceInfo, ipAddress, comments } = req.body;
...
exports.checkOut = async (req, res) => {
  try {
    const { tasksWorkedOn, comments } = req.body;
    ...
    attendance.tasksWorkedOn = tasksWorkedOn || [];
...
// Get all attendance (for managers/admin)
