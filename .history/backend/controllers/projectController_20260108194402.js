...
exports.addDiscussion = async (req, res) => {
  try {
    ...
    if (req.body.content) {
      ...
      ({ content, system, parentDiscussionId } = req.body);
    } else if (req.body && typeof req.body === 'object') {
      // FormData request - content might be in different format
      content = req.body.content || req.body.discussionContent;
      system = req.body.system || false;
      parentDiscussionId = req.body.parentDiscussionId;
    }
    
    console.log('addDiscussion called with:', { content: typeof content, contentValue: content, parentDiscussionId, files: req.files?.length });
